...
class ArtifactTemplate {
    ...
    artifactConfiguration = () => {
        ...
        this.askDays && createComboBox(referenceNode, 'askDays', '¿Cuantos días al mes los usas?', createNumericArray(1, 31))
        this.askHours && createComboBox(referenceNode, 'askHours', '¿Cuantos horas al día los usas?', createNumericArray(1, 24))
